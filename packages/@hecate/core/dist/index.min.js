var main = (function (e, t, n, r, a, o, i, u, c, l, f, s, d, g, v, m, p, h, b, y, P, _, x) {
    'use strict';
    function I(e) {
    ...
    var K = k.default,
        ...
        U = {
            ...
            setDriver: function (e) {
                return new O.default(function (t, n) {
                    t(L.default.setDriver(e));
                });
            },
            config: function (e) {
                return new O.default(function (t, n) {
                    t(L.default.config(e));
                });
            },
            createInstance: function (e) {
                return new O.default(function (t, n) {
                    t(L.default.createInstance(e));
                });
            },
        },
        V = {
            setObject: function (e, t) {
                localStorage.setItem(e, A.default(t));
            },
            ...
            array: {
                groupBy: function (e, t) {
                    ...
                    return (
                        ...
                        q.default((n = z.default(r))).call(n, function (e) {
                            return r[e];
                        })
                    );
                },
                sort: function (e, t) {
                    return D.default(e).call(e, function (e, n) {
                        var r = e[t],
                            a = n[t];
                ...
                find: function (e, t, n) {
                    return M.default(e).call(e, function (e) {
                        return e[n] === t[n];
                    });
                },
                remove: function (e, t, n) {
                    var r = E.default(e).call(e, function (e) {
                        return e[n] === t[n];
                    });
                    return C.default(e).call(e, r, 1), e;
                },
            },
            object: {
                isEmpty: function (e) {
                ...
                G.default(e, null, [
                    {
                        ...
                        value: function (e) {
                            ...
                            var a,
                                o = ne.attributes(e);
                            if (ne.isSelfCloseTag(e)) return R.default((a = '<'.concat(e.tag, ' '))).call(a, o, '/>');
                            var i = ne.children(e);
                            return R.default(
                                (t = R.default((n = R.default((r = '<'.concat(e.tag, ' '))).call(r, o, '>'))).call(
                                    n,
                                    i,
                                    '</'
                                ))
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (!n) return {};
                            var r = $.default(n.children, 1)[0];
                            return r ? re.node2json(r) : {};
                        },
                    },
                    {
                        key: 'selfCloseTags',
                ...
                G.default(e, null, [
                    {
                        ...
                        value: function (e) {
                            ...
                            var t = '',
                                n = z.default(e.attributes);
                            for (var r in n) {
                                var a;
                                if ({}.hasOwnProperty.call(n, r))
                                    t += R.default((a = ' '.concat(n[r], '="'))).call(a, e.attributes[n[r]], '"');
                            }
                            return t;
                        },
                    },
                        ...
                        value: function (e) {
                            ...
                            for (var n in e.children)
                                ({}.hasOwnProperty.call(e.children, n) &&
                                    ('object' == Y.default(e.children[n])
                                        ? (t += te.build(e.children[n]))
                                        : (t += e.children[n])));
                            return t;
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            for (var r in t.childNodes)
                                t.childNodes[r].nodeType === Node.ELEMENT_NODE && n.push(e.node2json(t.childNodes[r])),
                                    t.childNodes[r].nodeType === Node.TEXT_NODE && n.push(t.childNodes[r].textContent);
                            return n;
                        },
                    },
                    {
    ...
    return (e.convertor = oe), (e.lib = Z), (e.locales = ee), Object.defineProperty(e, '__esModule', { value: !0 }), e;
})(
    {},
    moment,
    lodash,
