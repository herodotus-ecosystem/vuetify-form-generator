var main = (function (e, t, r, a, n, o) {
    ...
    const f = d.default,
        ...
        p = {
            ...
            setDriver: (e) =>
                new Promise((t, r) => {
                    t(g.default.setDriver(e));
                }),
            config: (e) =>
                new Promise((t, r) => {
                    t(g.default.config(e));
                }),
            createInstance: (e) =>
                new Promise((t, r) => {
                    t(g.default.createInstance(e));
                }),
        },
        h = {
            setObject(e, t) {
    ...
    const N = y;
    var j = Object.freeze({ __proto__: null, json2html: N });
    return (e.convertor = j), (e.lib = P), (e.locales = v), Object.defineProperty(e, '__esModule', { value: !0 }), e;
})({}, moment, lodash, shortid, Swal, localForage);
