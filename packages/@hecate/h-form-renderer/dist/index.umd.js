!(function(e, t) {
                ...
                null != (u = e[l]) && null != u[Ke.reftoken]
                    ? ((n = u[Ke.reftoken]),
                      ...
                      be.default(n)
                          ...
                          : null != t[n]
                          ? (e[l] = t[n])
                          : String(n).match(new RegExp('^' + Ke.pathtoken)) && (e[l] = Ke.get_json_pointer(n, r, i)),
    ...
    var Ee = {
        ...
        Ne = {
            time: function(e, t) {
                var r,
                    i = new Date(he.default((r = ''.concat(new Date().toISOString().split('T')[0], 'T'))).call(r, e));
                    ...
                    if (((this.currentOneOf = null), this.subSchemas && !this.currentOneOf && this.subSchemasConstProp))
                        if (e && e[this.subSchemasConstProp.key])
                            this.currentOneOf = ue.default((i = this.subSchemas)).call(i, function(r) {
                                return r.properties[t.subSchemasConstProp.key].const === e[t.subSchemasConstProp.key];
                            });
                                ...
                                (this.dateProp.parts =
                                    ...
                                    [
                                        he
                                            ...
                                            .call(n, Ze(l.getDate())),
                                        he.default((s = ''.concat(Ze(l.getHours()), ':'))).call(s, Ze(l.getMinutes()))
                                    ])),
                                                ...
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 8:
                                                            return (
                                                                (e.next = 10),
                                                                at(r, t.resolvedSchema, t.fullOptions.filesAsDataUrl)
                                                            );
                                                        case 10:
    ...
    var ct = {
        ...
        dt = function(e, t, r) {
            ...
            return (
                ...
                !oe.default((l = [null, void 0])).call(l, t) && de.default(e[r]) === de.default(t[r])
            );
        };
    function ht(e, t) {
        var r;
    ...
    var Ot = {
                    ...
                    computed: {
                        ...
                        oneOfSelect: function() {
                            ...
                            return (
                                ...
                                !(
                                    !oe.default((t = ['string', 'integer', 'number'])).call(t, this.fullSchema.type) ||
                                    !this.fullSchema.oneOf
                                )
                            );
                        },
                                ...
                                if (r) {
                                    ...
                                    return (
                                        me.default(r).call(r, 'http://') || me.default(r).call(r, 'https://')
                                            ? (i = e('img', { domProps: { src: r }, style: 'height:100%;width:100%;' }))
                    ...
                    methods: {
                        renderArrayItemModal: function(e, t, r) {
                            ...
                            var s = {
                                ...
                                o = function() {
                                    i.componentInstance.resetValidation(), (n.editabledArrayProp.currentDialog = null);
                                };
                            return e(
                                'v-dialog',
                                {
                                    props: gt(
                                        ...
                                        {},
                                        { value: this.editabledArrayProp.currentDialog === r, closeOnContentClick: !1 }
                                    ),
                                    scopedSlots: s,
                                    on: { 'click:outside': o }
                                },
                                                            ...
                                                            i.componentInstance.validate(!0) &&
                                                                (a
                                                                    ...
                                                                    : ((n.editabledArrayProp.editedItems[r] = !0),
                                                                      n.$set(n.value, r, n.editabledArrayProp.editItem),
                                                                      n.$nextTick(function() {
                                                                          return n.$refs[
                                                                              'roItem-' + r
                                                                          ].initFromSchema();
                                                                  ...
                                                                  t.input(e),
                                                                      ...
                                                                      t.$nextTick(function() {
                                                                          for (var r = 0; r < e.length; r++)
                                                                              t.$refs['roItem-' + r].initFromSchema();
                                                                      });
                                                              }
                                                          }
                                                      },
                    ...
                    computed: {
                        ...
                        hasValidatedChildError: function() {
                            ...
                            return !!ue.default((e = this.inputs)).call(e, function(e) {
                                return e.hasValidatedChildError || (e.hasError && (e.validated || e.shouldValidate));
                            });
                        }
                    },
                    created: function() {
            ...
            computed: {
                fullOptions: function() {
                    var e = ('undefined' != typeof window && window) || ('undefined' != typeof global && global) || {},
                ...
                rules: function() {
                    return (function(e, t, r, i) {
                        ...
                        if ('string' === e.type && void 0 !== e.minLength) {
                            var c = t.messages.minLength.replace('{minLength}', e.minLength.toLocaleString(t.locale));
                            s.push(function(t) {
                                return null == t || t.length >= e.minLength || c;
                            });
                        }
                        if ('string' === e.type && void 0 !== e.maxLength) {
                            var f = t.messages.maxLength.replace('{maxLength}', e.maxLength.toLocaleString(t.locale));
                            s.push(function(t) {
                        ...
                        var p = ye.default((a = e['x-ruless'] || [])).call(a, function(e) {
                            return 'string' == typeof e ? t.rules && t.rules[e] : 'function' == typeof e ? e : void 0;
                        });
            ...
            render: function(e) {
                ...
                if (
                    ...
                    this.$scopedSlots.after
                        ...
                        : this.xSlots.after &&
                          i.push(e('div', { domProps: { innerHTML: this.fullOptions.markdown(this.xSlots.after) } }));
                    var n = xt({}, this.fullOptions.fieldColProps);
                    return (
                        this.fullSchema['x-cols'] && (n.cols = this.fullSchema['x-cols']),
                        e('v-col', { props: n, class: this.propertyClass, style: this.fullSchema['x-style'] || '' }, i)
                    );
                }
            },
            methods: {
                renderPropSlots: function(e) {
                    ...
                    return (
                        fe.default((t = ce.default(this.xSlots))).call(t, function(t) {
                            l.push(e('div', { slot: t, domProps: { innerHTML: i.fullOptions.markdown(i.xSlots[t]) } }));
                        }),
