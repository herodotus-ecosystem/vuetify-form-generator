var main = (function (e, t) {
    ...
    const s = {
            ...
            get_json_pointer: function (e, t, r) {
                var l, a;
                (l = e
                    .replace(/\\\//, '#SLASH#')
                    .replace(/\//g, '.')
                    ...
                    '.' === (l = l.replace(new RegExp('^' + s.pathtoken), ''))[0] && (l = l.substr(1, l.length - 1));
                try {
                    s.debug, (a = i.getter(l)(t));
                } catch (e) {
                    a = '';
                }
                return a;
                    ...
                    null != (u = e[l]) && null != u[s.reftoken]
                        ? ((a = u[s.reftoken]),
                          ...
                          Array.isArray(a)
                              ...
                              : null != t[a]
                              ? (e[l] = t[a])
                              : String(a).match(new RegExp('^' + s.pathtoken)) && (e[l] = s.get_json_pointer(a, i, r)),
                          null != (null != (n = e[l]) ? n.length : void 0) &&
                              0 === (null != (o = e[l]) ? o.length : void 0) &&
                              s.debug,
                          h.push(void 0))
                        : 'object' == typeof u
                        ? h.push(s.replace(u, t, i, r))
                        : h.push(void 0);
                return h;
            },
            extend: function (e, t) {
                ...
                if ('object' == typeof e) {
                    for (i in ((l = []), e)) {
                        if (((o = e[i]), i === s.extendtoken && null != o[s.reftoken])) {
                            for (a in ((r = s.get_json_pointer(o[s.reftoken], e, t)), o))
                                (n = o[a]), a !== s.reftoken && (r[a] = n);
                            delete e[i];
                        }
                        'object' == typeof o ? l.push((o = s.extend(o))) : l.push(void 0);
                    }
                    return l;
                }
            },
            ...
            evaluate: function (e, t, i) {
                var r, l, a;
                for (r in (null == i && (i = s.evaluateStr), (l = s.clone(e))))
                    'string' == typeof (a = l[r]) && (e[r] = i(a, t)),
                        'object' == typeof a && (e[r] = s.evaluate(a, t));
                return e;
            },
            evaluateStr: function (e, t) {
                if ('string' != typeof e) return e;
                if ('{' !== e[0] || '}' !== e[e.length - 1])
                    return e.replace(/(\{)(.*?)(\})/g, function (e, r, l) {
                        var a;
                        if (((a = ''), null == t || null == l)) return a;
                        if (null != t[l] && 'function' == typeof t[l]) a = t[l]();
                        else if (null != t[l]) a = t[l];
                        else {
                            try {
                                (l = l.replace(new RegExp('^' + s.pathtoken + '/'), '').replace(/\//g, '.')),
                                    (a = i.getter(l)(t));
                            } catch (e) {
                                (err = e), (a = '');
                            }
    ...
    const O = require('match-all'),
        x = require('debounce');
    function P(e, t, i, s, r, l, a, n, o, h) {
