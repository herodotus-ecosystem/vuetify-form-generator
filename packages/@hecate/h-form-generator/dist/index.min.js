var main = (function (e, t, s, a, n, o, l, r, i, p, c, d, u, m, v, h, b, f, g, x, _, k, I, w, $, C, y, V) {
    'use strict';
    function S(e) {
    ...
    var H = S(s),
        ...
        B = S(C),
        N = 'DRAWING_CANVAS',
        j = 'DRAWING_CANVAS_VERSION',
        M = function (e) {
            return e ? JSON.parse(e) : null;
        };
    function z(e) {
        d.lib.storageSync.setItem(N, P.default(e));
    }
    var W = {
            TEXT_FIELD: {
                index: 'TEXT_FIELD',
    ...
    function U(e) {
        if (!d.lib.lodash.isEmpty(e)) {
            var t = Y(e),
                s = (function (e) {
                    return !d.lib.lodash.isEmpty(e) && d.lib.lodash.has(e, K.annotations.xprops)
                        ? e[K.annotations.xprops]
                        : {};
                })(t),
                a = {};
            (a.tag = t.tag),
    ...
    function J(e) {
        var t = (function (e) {
                var t,
                    s = L.default((t = d.lib.lodash)).call(t, e, U);
    ...
    var Q = {
        ...
        we = {
            ...
            methods: {
                ...
                readSelectedItemParam: function (e) {
                    var t,
                        s = B.default((t = this.$lib.lodash)).call(t, this.selectedItems, function (t) {
                            return t.type === e;
                        });
                ...
                findRuleItemByType: function (e) {
                    var t;
                    return B.default((t = this.$lib.lodash)).call(t, this.ruleItems, function (t) {
                        return t.type === e;
                    });
                },
        ...
        Ye = {
            ...
            mounted: function () {
                var e = (function () {
                    if ('1.1' !== d.lib.storageSync.getItem(j)) return d.lib.storageSync.setItem(j, '1.1'), z([]), null;
                    var e = d.lib.storageSync.getItem(N);
                    return M(e);
                })();
                F.default(e) &&
                    e.length > 0 &&
            ...
            methods: {
                ...
                copyCanvasItem: function (e) {
                    var t = (function (e) {
                        return X(Y(e, e.configs.formId), e.configs.name, e.configs.document, e.configs.panel);
                    })(e);
                    this.changeDrawingCanvas(t);
                },
