var main = (function (e, t, s, a, n, o, r, i, l, p, c, d, u, m, h, v, b, f, g, x, k, _) {
    'use strict';
    function I(e) {
    ...
    function z(e) {
        if (!c.lib.lodash.isEmpty(e)) {
            var t = j(e),
                s = (function (e) {
                    return !c.lib.lodash.isEmpty(e) && c.lib.lodash.has(e, B.annotations.xprops)
                        ? e[B.annotations.xprops]
                        : {};
                })(t),
                a = {},
                n = t['x-rules'];
    ...
    (X.install = function (e) {
        ...
        null != ('undefined' == typeof window ? 'undefined' : w.default(window)) && window.Vue && X.install(window.Vue);
    var Y = {
        ...
        Le = {
            ...
            data: function () {
                return { constants: B, formSettings: {} };
            },
            watch: {
                schema: {
                    handler: function (e, t) {
        ...
        et = {
            ...
            methods: {
                ...
                copyCanvasItem: function (e) {
                    var t = (function (e) {
                        return N(j(e, e.configs.formId), e.configs.name, e.configs.document, e.configs.panel);
                    })(e);
                    this.changeDrawingCanvas(t);
                },
