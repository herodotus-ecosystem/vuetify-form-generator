...
import t from '@babel/runtime-corejs3/core-js/json/stringify';
import {
    VCard as s,
    VCol as a,
    VRow as n,
    VContainer as o,
    VListItemContent as r,
    VIcon as l,
    VBtn as i,
    ...
    VList as m,
    VExpansionPanelContent as h,
    VExpansionPanel as v,
    VTextField as b,
    VTooltip as f,
    VListItemTitle as g,
    VSelect as x,
...
import q from '@babel/runtime-corejs3/core-js/array/is-array';
...
import te from '@babel/runtime-corejs3/core-js/instance/index-of';
import se from '@babel/runtime-corejs3/core-js/instance/find';
import { HCodeMirror as ae } from '@hecate/h-code-mirror';
import { HFormRuntime as ne } from '@hecate/h-form-runtime';
var oe = function (e) {
    return e ? JSON.parse(e) : null;
};
function re(e) {
    K.storageSync.setItem('DRAWING_CANVAS', t(e));
}
var le = {
        TEXT_FIELD: {
            index: 'TEXT_FIELD',
    ...
    ie = [
        ...
        },
        {
            ...
            list: [
                {
                    configs: {
                        title: le.SLIDER.schema.title,
                        icon: 'mdi-tune-variant',
                        name: 'Slider',
                        document: 'https://vuetifyjs.com/zh-Hans/components/sliders/',
                        schema: le.SLIDER.index,
                    },
                },
                {
                    configs: {
                        title: le.RANGE_SLIDER.schema.title,
                        icon: 'mdi-valve-closed',
                        name: 'Range_Slider',
                        document: 'https://vuetifyjs.com/zh-Hans/components/sliders/',
                        schema: le.RANGE_SLIDER.index,
                    },
                },
                {
                    configs: {
                        title: le.CHECKBOX.schema.title,
                        icon: 'mdi-checkbox-marked',
                        name: 'Checkbox',
                        document: 'https://vuetifyjs.com/zh-Hans/components/checkboxes/',
                        schema: le.CHECKBOX.index,
                    },
                },
                {
                    configs: {
                        title: le.SWITCHS.schema.title,
                        icon: 'mdi-toggle-switch',
                        name: 'Switch',
                        document: 'https://vuetifyjs.com/zh-Hans/components/switches/',
                        schema: le.SWITCHS.index,
                    },
                },
                {
                    configs: {
                        title: le.DATE_PICKER.schema.title,
                        icon: 'mdi-calendar',
                        name: 'Date',
                        document: 'https://vuetifyjs.com/zh-Hans/components/date-pickers/',
                        schema: le.DATE_PICKER.index,
                    },
                },
                {
                    configs: {
                        title: le.TIME_PICKER.schema.title,
                        icon: 'mdi-clock-outline',
                        name: 'Time',
                        document: 'https://vuetifyjs.com/zh-Hans/components/time-pickers/',
                        schema: le.TIME_PICKER.index,
                    },
                },
                {
                    configs: {
                        title: le.SELECT_SINGLE.schema.title,
                        icon: 'mdi-form-dropdown',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/selects/',
                        schema: le.SELECT_SINGLE.index,
                    },
                },
                {
                    configs: {
                        title: le.COMBOBOX.schema.title,
                        icon: 'mdi-vector-difference-ab',
                        name: 'Combobox',
                        document: 'https://vuetifyjs.com/zh-Hans/components/combobox/',
                        schema: le.COMBOBOX.index,
                    },
                },
                {
                    configs: {
                        title: le.SELECT_MULTIPLE.schema.title,
                        icon: 'mdi-form-dropdown',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/selects/',
                        schema: le.SELECT_MULTIPLE.index,
                    },
                },
                {
                    configs: {
                        title: le.CASCADE_SELECT.schema.title,
                        icon: 'mdi-file-tree-outline',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/selects/',
                        schema: le.CASCADE_SELECT.index,
                    },
                },
                {
                    configs: {
                        title: le.RADIO.schema.title,
                        icon: 'mdi-checkbox-marked-circle',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/selection-controls/',
                        schema: le.RADIO.index,
                    },
                },
                {
                    configs: {
                        title: le.COLOR_PICKER.schema.title,
                        icon: 'mdi-calendar',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/color-pickers/',
                        schema: le.COLOR_PICKER.index,
                    },
                },
                {
                    configs: {
                        title: le.FILE_INPUT.schema.title,
                        icon: 'mdi-calendar',
                        name: 'Select',
                        document: 'https://vuetifyjs.com/zh-Hans/components/file-inputs/',
                        schema: le.FILE_INPUT.index,
                    },
                },
            ],
        },
...
function ue(e) {
    if (!K.lodash.isEmpty(e)) {
        var t = de(e),
            s = (function (e) {
                return !K.lodash.isEmpty(e) && K.lodash.has(e, pe.annotations.xprops) ? e[pe.annotations.xprops] : {};
            })(t),
            a = {};
        (a.tag = t.tag),
            (a.attributes = {}),
...
var ve = {
        components: { VCard: s, VCol: a, VRow: n, VContainer: o },
    ...
    ke = {
        components: { VExpansionPanelHeader: u, VList: m, VExpansionPanelContent: h, VExpansionPanel: v },
    ...
    $e = {
        components: { VTextField: b, VListItemContent: r, VIcon: l, VTooltip: f, VListItemAction: p, VListItem: c },
        name: 'HPanelColor',
        props: {
    ...
    Le = Q(
        ...
        undefined,
        {
            components: { VSelect: x, VListItemContent: r, VIcon: l, VTooltip: f, VListItemAction: p, VListItem: c },
            name: 'HPanelSelect',
            props: {
                value: { required: !0 },
                label: String,
    ...
    De = Q(
        ...
        undefined,
        {
            components: { VSwitch: _, VListItemContent: r, VIcon: l, VTooltip: f, VListItemAction: p, VListItem: c },
            name: 'HPanelSwitch',
            props: {
                value: Boolean,
                label: String,
                    ...
                    undefined,
                    {
                        ...
                        methods: {
                            ...
                            readSelectedItemParam: function (e) {
                                var t,
                                    s = se((t = this.$lib.lodash)).call(t, this.selectedItems, function (t) {
                                        return t.type === e;
                                    });
                            ...
                            findRuleItemByType: function (e) {
                                var t;
                                return se((t = this.$lib.lodash)).call(t, this.ruleItems, function (t) {
                                    return t.type === e;
                                });
                            },
                            changeRuleItemStatus: function (e) {
                                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                                    s = this.findRuleItemByType(e.type);
                                s.disabled = t;
                            },
    ...
    Re = Q(
        ...
        undefined,
        {
            components: { VCombobox: H, VListItemContent: r, VIcon: l, VTooltip: f, VListItemAction: p, VListItem: c },
            name: 'HPanelArray',
            props: {
                value: {
                    type: Array,
                    ...
                    undefined,
                    {
                                        ...
                                        SLIDER: Q(
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.InverseLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                ...
                                                                [
                                                                    s('h-panel-color', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ThumbColor]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ThumbLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-number', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ThumbSize]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    s('h-panel-array', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.TickLabels]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch-text-field', {
                                                                    ...
                                                                    s('h-panel-number', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.TickSize],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.TickSize,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.TickSize]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-color', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.TrackColor]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-color', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.TrackFillColor
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.TrackFillColor]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                            ...
                                            undefined,
                                            {
                                                ...
                                                components: {
                                                    ...
                                                    HPanelNumber: Oe,
                                                    HPanelSwitch: De,
                                                    HPanelSwitchTextField: Be,
                                                    HPanelTextField: Ee,
                                                    VExpansionPanels: S,
                                                },
                                                props: { element: { type: Object, default: function () {} } },
                                                data: function () {
                                                    return { constants: pe, dataObject: {} };
                                                },
                                                computed: {
                                                    properties: function () {
                                                        return this.dataObject[this.constants.annotations.xprops];
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.FalseValue]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.TrueValue]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                            ...
                                                            s(
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.OffIcon],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.OffIcon,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.OffIcon]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.OnIcon],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.OnIcon,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.OnIcon]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                    ...
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.IndeterminateIcon
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.IndeterminateIcon]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.SelectedItemsText
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.SelectedItemsText]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                            ...
                                                            s(
                                                                ...
                                                                [
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.PrevIcon],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.PrevIcon,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.PrevIcon]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.NextIcon],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.NextIcon,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.NextIcon]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.YearIcon],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.YearIcon,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.YearIcon]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    s('h-panel-number', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.FirstDayOfWeek
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.FirstDayOfWeek]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-number', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.LocaleFirstDayOfYear]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                    ...
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.PickerDate]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.PrevMonthAriaLabel
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.PrevMonthAriaLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.PrevYearAriaLabel
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.PrevYearAriaLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.NextMonthAriaLabel
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.NextMonthAriaLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.NextYearAriaLabel
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.NextYearAriaLabel]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ShowCurrent]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.ShowWeek],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.ShowWeek,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.ShowWeek]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-select', {
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-icon', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.DeletableChips
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.DeletableChips]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.SmallChips]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.HideSelected]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.NoDataText]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.CacheItems]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.DisableLookup
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.DisableLookup]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ReturnObject]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-color', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ItemColor]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ItemDisabled]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.ItemText],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.ItemText,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.ItemText]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-text-field', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.ItemValue]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.OpenOnClear]',
                                                                        },
                                                                    }),
                                                                ],
                                                                1
                                                                ...
                                                                [
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.AllowOverflow
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.AllowOverflow]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                ...
                                                                [
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[
                                                                                    e.constants.tags.AutoSelectFirst
                                                                                ],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.AutoSelectFirst]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            ...
                                                                            expression:
                                                                                'properties[constants.tags.HideNoData]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                                                                    ...
                                                                    s('h-panel-switch', {
                                                                        ...
                                                                        model: {
                                                                            value:
                                                                                e.properties[e.constants.tags.NoFilter],
                                                                            callback: function (t) {
                                                                                e.$set(
                                                                                    e.properties,
                                                                                    e.constants.tags.NoFilter,
                                                                                    t
                                                                                );
                                                                            },
                                                                            expression:
                                                                                'properties[constants.tags.NoFilter]',
                                                                        },
                                                                    }),
                                                                    e._v(' '),
                                                                    s('h-panel-switch', {
                        ...
                        data: function () {
                            return {
                                ...
                                drawingCanvasForm: {},
                                saveDrawingCanvasDebounce: J(340, re),
                            };
                        },
                        watch: {
                            drawingCanvas: {
                        ...
                        mounted: function () {
                            var e = (function () {
                                if ('1.1' !== K.storageSync.getItem('DRAWING_CANVAS_VERSION'))
                                    return K.storageSync.setItem('DRAWING_CANVAS_VERSION', '1.1'), re([]), null;
                        ...
                        methods: {
                            ...
                            addComponent: function (e) {
                                var t = (function (e) {
                                    return ce(
                                        le[e.configs.schema].schema,
                                        e.configs.name,
                                        e.configs.document,
                                        le[e.configs.schema].index
                                    );
                                })(e);
                ...
                formPreview: function () {
                    var e,
                        ...
                        a =
                            ...
                            K.lodash.isEmpty(e)
                                ? {}
                                : (W(e).call(e, function (e, t, a) {
                                      var n = e.configs.formId,
                                          o = de(e);
                                      s.properties[n] = o;
                                  }),
                                  s));
                    a && (this.schemaObject = t(a, null, '\t')), (this.formDrawer = !0);
                },
            },
        },
        undefined,
...
(je.install = function (e) {
    ...
    null != ('undefined' == typeof window ? 'undefined' : e(window)) && window.Vue && je.install(window.Vue);
export { je as HFormGenerator };
