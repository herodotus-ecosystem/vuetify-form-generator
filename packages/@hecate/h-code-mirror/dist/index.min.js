var main = (function(
    ...
    var me = he(n),
        ...
        Ce = {
            name: 'HCodeMirror',
            components: { codemirror: o.codemirror },
            props: {
            ...
            computed: {
                ...
                currentTheme: function() {
                    var e = this.theme && 'default' != this.theme ? this.theme : 'material-darker';
                ...
                resetLint: function() {
                    ...
                    this.$refs.editor.codemirror.setOption('lint', !1),
                        this.$nextTick(function() {
                            e.$refs.editor.codemirror.setOption('lint', !0);
                        });
                },
                onReady: function(e) {
    ...
    return (
        (window.JSHINT = ce.JSHINT),
        (window.CSSLint = ye.default),
        (window.jsonlint = fe.parser),
        (we.install = function(e) {
            e.component(we.name, we);
        }),
        null != ('undefined' == typeof window ? 'undefined' : me.default(window)) &&
            window.Vue &&
