!(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ? t(require('vuetify/lib'), require('@mdi/js'), require('@hecate/core'))
        : 'function' == typeof define && define.amd
        ? define(['vuetify/lib', '@mdi/js', '@hecate/core'], t)
        : t((e = 'undefined' != typeof globalThis ? globalThis : e || self).Vuetify, e['mdi-js'], e.core);
})(this, function (e, t, n) {
    'use strict';
    function i(e) {
    ...
    var s = i(t);
    function o(e, t, n, i, s, o, r, c, l, a) {
    ...
    const r = o(
        ...
        undefined,
        {
            ...
            watch: {
                value: {
                    handler(e, t) {
                        e && n.lib.lodash.startsWith(e, 'mdi-') ? (this.search = e.substring(4)) : (this.search = e);
                    },
                    immediate: !0,
                },
                search: {
                    handler(e, t) {
                        this.filteredIcons.length > 0 && !this.menu
                            ...
                            e && !n.lib.lodash.startsWith(e, 'mdi-')
            ...
            mounted() {
                this.icons = Object.keys(s).map((e) => n.lib.lodash.kebabCase(e));
            },
            methods: {
                select(e) {
    ...
    (r.install = function (e) {
        ...
        null != typeof window && window.Vue && r.install(window.Vue);
});
