!(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ? t(require('@mdi/js'), require('vuetify/lib'))
        : 'function' == typeof define && define.amd
        ? define(['@mdi/js', 'vuetify/lib'], t)
        : t((e = 'undefined' != typeof globalThis ? globalThis : e || self)['mdi-js'], e.Vuetify);
})(this, function (e, t) {
    'use strict';
    ...
    const a = {
        ...
        h = {
            mdiSvg: {
                calendar: e.mdiCalendar,
                clock: e.mdiClock,
                info: e.mdiInformation,
                add: e.mdiPlus,
                edit: e.mdiPencil,
                delete: e.mdiDelete,
            },
                ...
                renderDateProp(e) {
                    ...
                    if ('time' === this.fullSchema.format)
                        (t = e('v-time-picker', {
                            ...
                            on: { input: (e) => this.input(d(e)), change: (e) => this.change(d(e)) },
                        })),
                ...
                renderSimpleProp(e) {
                    ...
                    if (
                        ...
                        (t = 'v-combobox'),
                            ...
                            (i.type = 'string'),
                            (i.validateOnBlur = !0);
                        const s = c(l.prepareFullSchema(this.fullSchema.items), this.fullOptions);
                    ...
                    return (
                        this.htmlDescription && r.push(this.renderTooltip(e, o)),
                        (t = this.customTag ? this.customTag : t),
                        t ? [e(t, { props: i, domProps: s, on: a, scopedSlots: n }, r)] : null
                    );
                },
            },
        };
                            ...
                            change: async (e) => {
                                if ('array' === this.fullSchema.type) {
                                    const t = await Promise.all(
                                        e.map((e) => S(e, this.fullSchema.items, this.fullOptions.filesAsDataUrl))
                                    );
                                    this.input(t), this.change(t);
                                } else {
                                    const t = await S(e, this.resolvedSchema, this.fullOptions.filesAsDataUrl);
                                    this.input(t), this.change(t);
                                }
                            },
                        };
        ...
        if (t)
            if ('array' === e.type)
                t.map((e) => e)
                    ...
                    .forEach((e) => {
                        const t = l ? e : { [s]: e };
                        i.find((e) => O(e, t, s)) || i.push(t);
                    });
            else {
                const e = l ? t : { [s]: t };
                i.find((t) => O(t, e, s)) || i.push(e);
            }
    }),
        (v.fillList = (e, t, i, s) => {
            if (t)
                return i.length
                    ? (i.forEach((e) => {
                          t.find((t) => O(e, t, s)) || t.push(e);
                      }),
                      t.forEach((e, l) => {
                          i.find((t) => O(t, e, s)) || (t[l] = null);
                      }),
                      t.filter((e) => !!e))
                    : [];
        });
                ...
                b,
                {
                    ...
                    methods: {
                        ...
                        updateSelectItems() {
                            ...
                            'list' === this.display &&
                                this.$emit('input', v.fillList(this.fullSchema, this.value, e, this.itemKey)),
                                v.fillSelectItems(this.fullSchema, this.value, e, this.itemKey, this.returnObject),
    ...
    (V.install = function (e) {
        ...
        null != typeof window && window.Vue && V.install(window.Vue);
});
