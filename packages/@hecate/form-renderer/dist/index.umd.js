!(function (e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ? t(exports, require('@mdi/js'), require('vuetify/lib'))
        : 'function' == typeof define && define.amd
        ? define(['exports', '@mdi/js', 'vuetify/lib'], t)
        : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).main = {}), e['mdi-js'], e.Vuetify);
})(this, function (e, t, i) {
    'use strict';
    var s = require('property-expr');
    const l = {
            cache: {},
            extendtoken: '$extend',
            reftoken: '$ref',
            ...
            clone: function (e) {
                ...
                for (t in ((i = e.constructor()), e)) i[t] = l.clone(e[t]);
                return i;
            },
            ...
            get_json_pointer: function (e, t, i) {
                ...
                (r = e
                    ...
                    '.' === (r = r.replace(new RegExp('^' + l.pathtoken), ''))[0] && (r = r.substr(1, r.length - 1));
                try {
                    l.debug, (a = s.getter(r)(t));
                } catch (e) {
                    a = '';
                }
                return a;
                    ...
                    null != (c = e[r]) && null != c[l.reftoken]
                        ? ((a = c[l.reftoken]),
                          ...
                          Array.isArray(a)
                              ...
                              : null != t[a]
                              ? (e[r] = t[a])
                              : String(a).match(new RegExp('^' + l.pathtoken)) && (e[r] = l.get_json_pointer(a, i, s)),
                          null != (null != (n = e[r]) ? n.length : void 0) &&
                              0 === (null != (o = e[r]) ? o.length : void 0) &&
                              l.debug,
                          h.push(void 0))
                        : 'object' == typeof c
                        ? h.push(l.replace(c, t, i, s))
                        : h.push(void 0);
                return h;
            },
            extend: function (e, t) {
                ...
                if ('object' == typeof e) {
                    for (i in ((r = []), e)) {
                        if (((o = e[i]), i === l.extendtoken && null != o[l.reftoken])) {
                            for (a in ((s = l.get_json_pointer(o[l.reftoken], e, t)), o))
                                (n = o[a]), a !== l.reftoken && (s[a] = n);
                            delete e[i];
                        }
                        'object' == typeof o ? r.push((o = l.extend(o))) : r.push(void 0);
                    }
                    return r;
                }
            },
            resolve: function (e, t) {
                var i;
                return (i = {}), l.findIds(e, i), l.debug && Object.keys(i).length, l.replace(e, i, e, t), e;
            },
            evaluate: function (e, t, i) {
                var s, r, a;
                for (s in (null == i && (i = l.evaluateStr), (r = l.clone(e))))
                    'string' == typeof (a = r[s]) && (e[s] = i(a, t)),
                        'object' == typeof a && (e[s] = l.evaluate(a, t));
                return e;
            },
                ...
                if ('{' !== e[0] || '}' !== e[e.length - 1])
                    return e.replace(/(\{)(.*?)(\})/g, function (e, i, r) {
                        ...
                        if (null != t[r] && 'function' == typeof t[r]) a = t[r]();
                            ...
                            try {
                                (r = r.replace(new RegExp('^' + l.pathtoken + '/'), '').replace(/\//g, '.')),
                                    (a = s.getter(r)(t));
                            } catch (e) {
                                (err = e), (a = '');
                            }
                        ...
                        return l.evaluateStr(a, t), a;
                    });
                try {
                    return s.getter(e.replace(/^{/, '').replace(/}$/, ''))(t);
                } catch (e) {
                    return null;
                }
            },
        ...
        r = {},
        a = (e) => Object.keys(e || {}).map((t) => ({ ...e[t], key: t }));
    r.prepareFullSchema = (e, t) => {
        const i = JSON.parse(JSON.stringify(e));
        return (
            i.pattern && (i.patternRegexp = new RegExp(i.pattern)),
            !i.type && i.properties && (i.type = 'object'),
            'object' !== i.type ||
                ((i.properties = JSON.parse(JSON.stringify(a(i.properties)))),
                ...
                i.dependencies &&
                    Object.keys(i.dependencies).forEach((e) => {
                        ...
                        [null, void 0, !1].includes(l) ||
                            ...
                            (i.properties = i.properties.concat(a(s.properties))),
    ...
    const n = {
        ...
        c = {
            mdiSvg: {
                calendar: t.mdiCalendar,
                clock: t.mdiClock,
                info: t.mdiInformation,
                add: t.mdiPlus,
                edit: t.mdiPencil,
                delete: t.mdiDelete,
            },
            ...
            return (
                ...
                ((e) => {
                    const t = e.getTimezoneOffset(),
                        i = `${p(parseInt(Math.abs(t / 60)))}:${p(Math.abs(t % 60))}`;
                    let s;
                    return (
                        (s = t < 0 ? '+' + i : t > 0 ? '-' + i : 'Z'),
                        `${e.getFullYear()}-${p(e.getMonth() + 1)}-${p(e.getDate())}T${p(e.getHours())}:${p(
                            e.getMinutes()
                        )}:${p(e.getSeconds())}${s}`
                    );
                })(t)
                ...
                renderDateProp(e) {
                    ...
                    if ('time' === this.fullSchema.format)
                        ...
                        this.value !== this.dateProp.lastValue &&
                            (this.dateProp.parts = [
                                `${(s = new Date(this.value)).getFullYear()}-${p(s.getMonth() + 1)}-${p(s.getDate())}`,
                                `${p(s.getHours())}:${p(s.getMinutes())}`,
                            ]),
                            (this.dateProp.lastValue = this.value);
                        const i = () => {
                                if (this.dateProp.parts[1]) {
                                    const e = d(this.dateProp.parts);
            ...
            methods: {
                renderSimpleProp(e) {
                    ...
                    const i = { ...this.commonFieldProps },
                        ...
                        a = { input: (e) => this.input(e), change: (e) => this.change(e) },
                        n = {};
                    let o = 'append-outer';
                    if (
                        ('string' === this.fullSchema.type &&
                        ...
                        (t = 'v-combobox'),
                            ...
                            (i.type = 'string'),
                            (i.validateOnBlur = !0);
                        const s = u(r.prepareFullSchema(this.fullSchema.items), this.fullOptions);
                    ...
                    return (
                        ...
                        t ? [e(t, { props: i, domProps: s, on: a, scopedSlots: n }, l)] : null
                    );
                },
            },
        };
                            ...
                            change: async (e) => {
                                if ('array' === this.fullSchema.type) {
                                    const t = await Promise.all(
                                        e.map((e) => g(e, this.fullSchema.items, this.fullOptions.filesAsDataUrl))
                                    );
                                    this.input(t), this.change(t);
                                } else {
                                    const t = await g(e, this.resolvedSchema, this.fullOptions.filesAsDataUrl);
                                    this.input(t), this.change(t);
                                }
                            },
                        };
        ...
        if (t)
            if ('array' === e.type)
                t.map((e) => e)
                    ...
                    .forEach((e) => {
                        const t = l ? e : { [s]: e };
                        i.find((e) => x(e, t, s)) || i.push(t);
                    });
            else {
                const e = l ? t : { [s]: t };
                i.find((t) => x(t, e, s)) || i.push(e);
            }
    }),
        (O.fillList = (e, t, i, s) => {
            if (t)
                return i.length
                    ? (i.forEach((e) => {
                          t.find((t) => x(e, t, s)) || t.push(e);
                      }),
                      t.forEach((e, l) => {
                          i.find((t) => x(t, e, s)) || (t[l] = null);
                      }),
                      t.filter((e) => !!e))
                    : [];
        });
    const P = require('match-all'),
        I = require('debounce');
    function k(e, t, i, s, l, r, a, n, o, h) {
        ...
        undefined,
        {
                ...
                v,
                {
                    ...
                    methods: {
                        ...
                        updateSelectItems() {
                            ...
                            'list' === this.display &&
                                this.$emit('input', O.fillList(this.fullSchema, this.value, e, this.itemKey)),
                                O.fillSelectItems(this.fullSchema, this.value, e, this.itemKey, this.returnObject),
            ...
            computed: {
                fullOptions() {
                    ...
                    return (
                        (t.icons = { ...c[i], ...t.icons }),
                        (t.messages = { ...(o[t.locale] || o.en), ...t.messages }),
                        (t.formats = { ...h, ...t.formats }),
                ...
                resolvedSchema() {
                    return 'root' === this.modelKey
                        ? l.resolve(this.schema, { '~$locale~': (this.options && this.options.locale) || 'en' })
                        : this.schema;
                },
                fullSchema() {
                    return r.prepareFullSchema(this.resolvedSchema, this.value);
                },
                htmlDescription() {
                ...
                rules() {
                    return u(this.fullSchema, this.fullOptions, this.required, this.isOneOfSelect);
                },
                disabled() {
            ...
            methods: {
                ...
                initFromSchema() {
                    if (this.fullSchema.readOnly && this.fullOptions.deleteReadOnly) return this.$emit('input', void 0);
                    let e = this.value;
    ...
    const C = k(
        ...
        undefined,
        {
            ...
            components: {
                VAvatar: i.VAvatar,
                VAutocomplete: i.VAutocomplete,
                VBtn: i.VBtn,
                VCard: i.VCard,
                VCardActions: i.VCardActions,
                VCardText: i.VCardText,
                VCardTitle: i.VCardTitle,
                VCheckbox: i.VCheckbox,
                VChip: i.VChip,
                VColorPicker: i.VColorPicker,
                VCombobox: i.VCombobox,
                VContainer: i.VContainer,
                VDatePicker: i.VDatePicker,
                VDialog: i.VDialog,
                VExpansionPanels: i.VExpansionPanels,
                VExpansionPanel: i.VExpansionPanel,
                VExpansionPanelHeader: i.VExpansionPanelHeader,
                VExpansionPanelContent: i.VExpansionPanelContent,
                VCol: i.VCol,
                VFileInput: i.VFileInput,
                VIcon: i.VIcon,
                VInput: i.VInput,
                VRow: i.VRow,
                ...
                VSlider: i.VSlider,
                VSpacer: i.VSpacer,
                VSubheader: i.VSubheader,
                VSwitch: i.VSwitch,
                VTabs: i.VTabs,
                VTab: i.VTab,
                VTabItem: i.VTabItem,
                VTextarea: i.VTextarea,
                VTextField: i.VTextField,
                VTimePicker: i.VTimePicker,
                VTooltip: i.VTooltip,
            },
            mixins: [V],
        },
