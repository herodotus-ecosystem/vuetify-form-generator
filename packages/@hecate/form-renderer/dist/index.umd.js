!(function (e, t) {
    ...
    const l = {
                    ...
                    null != (u = e[r]) && null != u[l.reftoken]
                        ? ((n = u[l.reftoken]),
                          ...
                          Array.isArray(n)
                              ...
                              : null != t[n]
                              ? (e[r] = t[n])
                              : String(n).match(new RegExp('^' + l.pathtoken)) && (e[r] = l.get_json_pointer(n, i, s)),
                          null != (null != (a = e[r]) ? a.length : void 0) &&
                              0 === (null != (o = e[r]) ? o.length : void 0) &&
                              l.debug,
                          h.push(void 0))
                        : 'object' == typeof u
                        ? h.push(l.replace(u, t, i, s))
                        : h.push(void 0);
                return h;
            },
            extend: function (e, t) {
                ...
                if ('object' == typeof e) {
                    for (i in ((r = []), e)) {
                        if (((o = e[i]), i === l.extendtoken && null != o[l.reftoken])) {
                            for (n in ((s = l.get_json_pointer(o[l.reftoken], e, t)), o))
                                (a = o[n]), n !== l.reftoken && (s[n] = a);
                            delete e[i];
                        }
            ...
            evaluate: function (e, t, i) {
                ...
                for (s in (null == i && (i = l.evaluateStr), (r = l.clone(e))))
                    'string' == typeof (n = r[s]) && (e[s] = i(n, t)),
                        'object' == typeof n && (e[s] = l.evaluate(n, t));
                return e;
            },
        ...
        r = {},
        n = (e) => Object.keys(e || {}).map((t) => ({ ...e[t], key: t }));
    r.prepareFullSchema = (e, t) => {
        ...
        return (
            ...
            'object' !== i.type ||
                ((i.properties = JSON.parse(JSON.stringify(n(i.properties)))),
                ...
                i.dependencies &&
                    Object.keys(i.dependencies).forEach((e) => {
                        ...
                        [null, void 0, !1].includes(l) ||
                            ...
                            (i.properties = i.properties.concat(n(s.properties))),
            ...
            return (
                ...
                ((e) => {
                    const t = e.getTimezoneOffset(),
                        i = `${m(parseInt(Math.abs(t / 60)))}:${m(Math.abs(t % 60))}`;
                    let s;
                    return (
                        (s = t < 0 ? '+' + i : t > 0 ? '-' + i : 'Z'),
                        `${e.getFullYear()}-${m(e.getMonth() + 1)}-${m(e.getDate())}T${m(e.getHours())}:${m(
                            e.getMinutes()
                        )}:${m(e.getSeconds())}${s}`
                    );
                })(t)
                ...
                renderDateProp(e) {
                    ...
                    if ('time' === this.fullSchema.format)
                        ...
                        this.value !== this.dateProp.lastValue &&
                            (this.dateProp.parts = [
                                `${(s = new Date(this.value)).getFullYear()}-${m(s.getMonth() + 1)}-${m(s.getDate())}`,
                                `${m(s.getHours())}:${m(s.getMinutes())}`,
                            ]),
    ...
    const P = require('match-all'),
        I = require('debounce');
    function k(e, t, i, s, l, r, n, a, o, h) {
    ...
    const V = k(
        ...
        undefined,
        {
                ...
                v,
                {
                    ...
                    methods: {
                        ...
                        updateSelectItems() {
                            ...
                            'list' === this.display &&
                                this.input(O.fillList(this.fullSchema, this.value, e, this.itemKey)),
            ...
            computed: {
                ...
                rules() {
                    return c(this.fullSchema, this.fullOptions, this.required, this.isOneOfSelect);
                },
                disabled() {
